...
* [`src/cmap/styles.cljs`](src/cmap/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/cmap/`](src/cmap/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cmap/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `cmap` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/cmap/config.cljs) defaults to `true` in
